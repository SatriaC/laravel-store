                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="product-title">Product Name</div>
                                            <div class="product-subtitle">Shritup Marzan</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <form action="{{ route('dashboard-transaction-update',$transaction->id) }}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <template v-if="status=='SHIPPING'">
                                                ...
                                                <div class="col-md-2">
                                                    <button class="btn btn-success btn-block mt-4" type="submit">Update Resi</button>
                                                </div>
                                            </template>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success btn-lg mt-4" type="submit">Save Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
