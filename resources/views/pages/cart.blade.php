        ...
        <form action="{{ route('checkout') }}" method="POST" id="locations">
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="zip_code" name="zip_code" value="40512" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="phone_number" name="phone_number" value="+6281234567890" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row" data-aos="fade-up" data-aos-delay="150">
